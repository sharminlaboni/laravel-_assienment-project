    ...
    <div class="container category-width">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="card card_category">
                    <div class="card-title">
                        <i class="fa-solid fa-capsules"></i><br>
                        Capsule
                    </div>
                    <div class="card-body">
                        <button type="button" class="btn btn-outline-primary btn-sm">View</button>
            ...
            <div class="col-md-3">
                <div class="card card_category">
                    <div class="card-title">
                        <i class="fa-solid fa-bottle-droplet"></i><br>
                        Liquid
                    </div>
                    <div class="card-body">
                        <button type="button" class="btn btn-outline-primary btn-sm">View</button>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="card card_category">
                    <div class="card-title">
                        <i class="fa-solid fa-head-side-cough"></i><br>
                        Inhalers
                    </div>
                    <div class="card-body">
                        <button type="button" class="btn btn-outline-primary btn-sm">View</button>
            ...
            <div class="col-md-3">
                <div class="card card_category">
                    <div class="card-title">
                        <i class="fa-solid fa-box-archive"></i><br>
                        Others
                    </div>
                    <div class="card-body">
                        <button type="button" class="btn btn-outline-primary btn-sm">View</button>
        ...
        <div class="container">
            <a href="./category_add.html" class="btn btn-outline-primary">Add New Category</a>
        </div>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Category Name Change</h5>
