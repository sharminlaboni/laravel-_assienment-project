...
<html lang="en">
  ...
  <body>
          ...
          <ul class="navbar-nav">
            ...
            <li>
              ...
              <div class="collapse" id="layouts2">
                <ul class="navbar-nav ps-3">
                  <li>
                    <a href="../admin_orderlist/order_list.html" class="nav-link px-3">
                      <span class="me-2"><i class="bi bi-card-checklist"></i> </span>
            ...
            <li>
              ...
              <div class="collapse" id="layouts3">
                <ul class="navbar-nav ps-3">
                  <li>
                    <a href="../admin_salelist/sale_list.html" class="nav-link px-3">
                      <span class="me-2"><i class="bi bi-card-checklist"></i> </span>
    ...
    <div class="container mt-3">
        <div class="card" style="width: 30vw;margin: auto;">
            <div class="card-body">
                <div class="card-text">
                    <form action="">
                        <div class="mb-3">
                        ...
                        <a href="../dashboard/dashboard.html" class="btn btn-secondary">Cancel</a>
                      </form>
                </div>
            </div>
        </div>
